/*******************************************************************************************
  ...
  NOTE: Along with tries, you can learn file handling and command line arguments in this
  program (Students from S2 have some issues with these topics; not sure about S1).
